...
var menuSound, gameOverSound;
var boosterSound, hitSound, levelCompleteSound, enemySound;
function preload()
{
  ...
  fireSound = loadSound("Audios/firing4.wav");

  menuSound = loadSound("Audios/menuSound.mp3");

  gameOverSound = loadSound("Audios/gameOver.wav");

  boosterSound = loadSound("Audios/coin.mp3");

  hitSound = loadSound("Audios/hit.wav");

  levelCompleteSound = loadSound("Audios/levelComplete.wav");

  enemySound = loadSound("Audios/enemy2.wav")
  }
function setup() {
